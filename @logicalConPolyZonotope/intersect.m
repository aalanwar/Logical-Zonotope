...
%     S = conPolyZono(S);
    ...
    %cPZ.b = [cPZ.b; S.b; xor(S.c ,not(cPZ.c))];
    cPZ.b = [cPZ.b; S.b; xor(S.c ,(cPZ.c))];
    
    g1Len = length(cPZ.G);
    g2Len = length(S.G);
    A = [cell2mat(cPZ.G) cell2mat(S.G)];
    % A=[];
    % for i=1:g1Len
    %     A =  [A cPZ.G{i}];
    % end
